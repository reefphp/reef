...
final class SubmissionTableTest extends TestCase {
	
	const ROWS = [
		['entry_id' => 1, 'input_1' => 'asdf', 'input_2' => true],
		['entry_id' => 2, 'input_1' => '', 'input_2' => false],
		['entry_id' => 3, 'input_1' => 'test test', 'input_2' => true],
	];
	...
	public function testTable(): void {
		$a_table = static::$Form->getSubmissionTable()->getTable();
	...
	public function testGenerator(): void {
		$i = 0;
		foreach(static::$Form->getSubmissionTable()->getGenerator() as $a_row) {
	...
	public function testCSV(): void {
		$a_table = array_map('str_getcsv', explode(PHP_EOL, static::$Form->getSubmissionTable()->CSV()));
